    ...
    <section className={styles.chat}>
      ...
      <div className={styles.chat__body}>
        ...
        {messages.map(message => (
          ...
          <div key={message._id} className={styles.chat__message_container} id={message.received === true ? styles.chat__message_received : styles.chat__message_send}>
